      ...
      <div className="container-custom py-20">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-16">
          ...
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-3xl font-bold mb-4">
              PRESET<span className="text-primary-400">SHOP</span>
            </h3>
            <p className="text-neutral-400 max-w-md mb-8 leading-relaxed">
              Transform your photography with our premium Lightroom presets.
              Crafted by professionals for creators who demand excellence.
            </p>
            ...
            <div className="mb-8">
              ...
              <a
                ...
                className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-full transition-all duration-300 hover:scale-105 shadow-lg hover:shadow-xl"
              >
            ...
            <div>
              ...
              <div className="flex gap-3">
                <a href="#" className="w-11 h-11 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary-600 transition-all duration-300 hover:scale-110">
        ...
        <div className="mt-12 pt-8 border-t border-neutral-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-neutral-400 text-sm">
            © 2024 PresetShop. All rights reserved.
          </p>
